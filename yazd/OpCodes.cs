...
namespace yazd
{
    ...
    public static class OpCodes
    {
        ...
        public static OpCode[] dasm_base = new OpCode[]
        {
			...
			new OpCode( "RST $00"           , 11 ,  0 , OpCodeFlags.Restarts), /* C7 */
			...
			new OpCode( "RST $08"           , 11 ,  0 , OpCodeFlags.Restarts), /* CF */
			...
			new OpCode( "RST $10"           , 11 ,  0 , OpCodeFlags.Restarts), /* D7 */
			...
			new OpCode( "RST $18"           , 11 ,  0 , OpCodeFlags.Restarts), /* DF */
			...
			new OpCode( "RST $20"           , 11 ,  0 , OpCodeFlags.Restarts), /* E7 */
			...
			new OpCode( "RST $28"           , 11 ,  0 , OpCodeFlags.Restarts), /* EF */
			...
			new OpCode( "RST $30"           , 11 ,  0 , OpCodeFlags.Restarts), /* F7 */
